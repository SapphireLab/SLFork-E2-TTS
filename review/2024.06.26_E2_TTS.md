...
> **Voicebox** [^18] and **MatchaTTS** [^19] used a flow-matching model \cite{lipman2022flow} conditioned by an input text.
...
> <u>Footnote: Alternatively, we can represent $y$ as a sequence of Unicode bytes~\cite{li2019bytes}.</u>
